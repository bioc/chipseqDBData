---
title: Aligning reads for the H3K9ac dataset
author: Aaron Lun
date: 3 April 2018
output:
...
```{r}
sra.numbers <- c("SRR499718", "SRR499719", 
				 "SRR499720", "SRR499721", 
				 "SRR499734", "SRR499735", "SRR499736", "SRR499737", 
				 "SRR499738")
grouping <-    c("proB-8113", "proB-8113", 
			     "proB-8108", "proB-8108", 
...
for (sra in sra.numbers) {
    ...
    stopifnot(code==0L)
    tmp <- file.path("~/ncbi/public/sra", paste0(sra, ".sra"))
...
align(index="index/mm10", readfile1=group.fastq, TH1=2, type=1, input_format="gzFASTQ", output_file=bam.files)
```
